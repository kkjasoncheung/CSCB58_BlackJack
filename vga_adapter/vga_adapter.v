 ...
 *                otherwise.
 * - COLOUR_CHANNEL_DEPTH - an integer specifying how many bits are available to describe each colour
...
module vga_adapter(
	...
	/* The colour input can be either 1 bit or 3*COLOUR_CHANNEL_DEPTH bits wide, depending on
	 * the setting of the MONOCHROME parameter.
	 */
	input [((MONOCHROME == "TRUE") ? (0) : (COLOUR_CHANNEL_DEPTH*3-1)):0] colour;
	...
	wire [((MONOCHROME == "TRUE") ? (0) : (COLOUR_CHANNEL_DEPTH*3-1)):0] to_ctrl_colour;
	...
	defparam
		VideoMemory.WIDTH_A = ((MONOCHROME == "FALSE") ? (COLOUR_CHANNEL_DEPTH*3) : 1),
		VideoMemory.WIDTH_B = ((MONOCHROME == "FALSE") ? (COLOUR_CHANNEL_DEPTH*3) : 1),
	...
	vga_controller controller(
		...
		defparam controller.COLOUR_CHANNEL_DEPTH = COLOUR_CHANNEL_DEPTH;
